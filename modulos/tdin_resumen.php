...
$query_rs1 = "SELECT fecha, td_tipos_id, COUNT(*) AS tot, DATE_FORMAT(fecha, '%Y-%m-%d') AS dd
FROM folioint WHERE c_oficina=$varssess GROUP BY dd, td_tipos_id ORDER BY fecha DESC";
...
<h1>Resumen de los Expedientes (Internos)</h1>
