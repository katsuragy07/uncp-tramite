...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO td_tipos (id, nombre, abrev, `int`, ext) VALUES (%s, %s, %s, %s, %s)",
...
mysql_select_db($database_cn1, $cn1);
$query_rs1 = "SELECT * FROM td_tipos ORDER BY nombre ASC";
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><h2>Lista de tipos de documentos registrados</h2>
        <table width="90%" border="0" cellpadding="0" cellspacing="0" class="tabla2">
          <tr>
            ...
            <td class="btit_1">Abreviatura</td>
            <td width="60" align="center" class="btit_1">Interno</td>
            <td width="60" align="center" class="btit_1">Externo</td>
          ...
          <?php if ($totalRows_rs1 > 0) { // Show if recordset not empty ?>
            <tr>
              ...
              <td width="60" align="center"><?php echo dev_sinoc($row_rs1['int']); ?></td>
              <td width="60" align="center"><?php echo dev_sinoc($row_rs1['ext']); ?></td>
    ...
    <td width="250" valign="top"><h2>Opciones</h2>
        ...
        <div class="bcont2">
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr valign="baseline">
                <td class="normal">Abreviatura:</td>
              </tr>
              <tr valign="baseline">
                <td><span id="sprytextfield1">
                  <label>
                  <input name="abrev" type="text" class="tbox1" id="abrev" />
                  </label></span></td>
              </tr>
              <tr valign="baseline">
                <td>
                <p><label><input name="int" type="checkbox" id="int" value="1" checked="checked" /> 
            Trámites internos</label><br>
            <label><input name="ext" type="checkbox" id="ext" value="1" checked="checked" /> 
