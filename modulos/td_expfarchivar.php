...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO log_archivo (id, tipo, folioext_id, forma, obs, fecha, `user`, c_oficina, provei, file, ext, size, empid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['user'], "text"),
							  ...
							  GetSQLValueString($_POST['provei'], "text"),
  ...
  mysql_select_db($database_cn1, $cn1);
  $id_f_ext = $_GET['pk'];
  $query_rs0 = "SELECT * FROM folioext WHERE id='$id_f_ext' LIMIT 1;";
  ...
  try{
    ...
    $cuerpo = ' 
      <html> 
        ...
        <body> 
          ...
          <p> 
          <b>
            Su tramite realizado a finalizado, puede consultar los detalles del mismo en el siguiente enlace:<br> 
            <a href="https://gestionuncp.edu.pe/tramite/vecinos/seguimiento.php?pk='.$id_f_ext.'">Seguimiento</a> 
            <br><br>
          </b>
            <p>Si no puede abrir el enlace anterior, copie y pegue la siguiente direccion en su navegador web. <br>
              https://gestionuncp.edu.pe/tramite/vecinos/seguimiento.php?pk='.$id_f_ext.'
            </p>
          </p>  	
        </body> 
      </html>'; 
    ...
    echo '<script>alert("error al enviar correo al usuario");</script>';
  }
...
echo '<script>alert("aaaaaaaaa1");</script>';
echo '<script>alert("'.$row_rs0['obs'].'");</script>';
*/
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <h2>Archivar Expediente con proveido</h2>
...
<option value="1">Copia</option>
        ...
        <tr valign="baseline">
          ...
          <td><textarea name="obs" rows="4" class="tbox2" id="obs"></textarea></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td width="130" align="right" valign="middle" class="btit_3">Notificación</td>
          <td>
            <div class="alert alert-warning" role="alert">
              Al confirmar esta acción, el expediente figurará como finalizado y se le notificará al interesado que realizo el trámite del estado de la misma via correo electrónico.
            </div>
          </td>
        </tr>
        <tr valign="baseline">
          <td width="130">&nbsp;</td>
          <td><input type="submit" class="but1" value="Finalizar"></td>
          </tr>
      </table>
