...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE users SET pass=%s WHERE id=%s",
    ...
    <form method="POST" name="form1" action="<?php echo $editFormAction; ?>">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
        ...
        <tr valign="baseline">
          ...
          <td class="med"><strong><?php echo $row_rs4['nombre']; ?></strong></td>
          </tr>
        <tr valign="baseline">
          <td width="150" align="right" valign="middle">Escriba su nueva contraseña</td>
          <td><span id="sprytextfield2">
            <input name="pass" type="text" class="tbox1" id="pass" />
            <span class="textfieldMinCharsMsg">Se necesitan 8 car&aacute;cteres como m&iacute;nimo</span></span>
            </td>
        </tr>
