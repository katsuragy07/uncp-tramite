...
$query_rs1 = ("SELECT * FROM acuerdos ORDER BY anno DESC, num DESC");
...
<h2>Lista de valores registrados</h2>
...
?>  
  ...
  <li><a href="javascript:dlitem(<?php echo $row_rs1['id']; ?>);">
    ...
    <td width="250" valign="top"><h2>Opciones</h2>
        ...
        <div class="spacer"><a href="acu_add.php" >
            <div class="skin left" style="background-position:-32px -79px;margin-right:3px;"></div>
            Agregar un acuerdo</a></div>

        </div>
        
        
        <div class="btit_2">Filtros</div>
        <div class="bcont">
        
        

		<div class="spacer"><a href="acu_pend.php" >
          <div class="skin left" style="background-position:-96px -63px;margin-right:3px;"></div>
          Sesiones con acuerdos pendientes</a></div>
