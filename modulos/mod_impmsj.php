...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opciones SET valor=%s WHERE id=%s",
                       GetSQLValueString(nl2br($_POST['valor']), "text"),
                       GetSQLValueString($_POST['id'], "int"));

  mysql_select_db($database_cn1, $cn1);
  $Result1 = mysql_query($updateSQL, $cn1) or die(mysql_error());

  $updateGoTo = "../modulos/mod_impmsj.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_cn1, $cn1);
$query_rs1 = "SELECT * FROM opciones WHERE id = 1";
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <h2>Mensaje para los formatos de impresión</h2>
    ...
    <form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
        ...
        <tr valign="baseline">
          ...
          <td valign="middle"><textarea name="valor" rows="10" class="tbox2" id="valor"><?php echo strip_tags($row_rs1['valor']); ?></textarea></td>
        </tr>
        <tr valign="baseline">
          <td width="150">&nbsp;</td>
