...
mysql_select_db($database_cn1, $cn1);
$query_sigla = "SELECT siglas FROM `oficinas` WHERE `id` =".$row_rs2['oficinas_id'];
$sigla = mysql_query($query_sigla, $cn1) or die(mysql_error());
$row_sigla = mysql_fetch_assoc($sigla);
$totalRows_sigla = mysql_num_rows($sigla);
?>
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
        ...
        <tr valign="baseline">
          ...
          <td><span id="sprytextfield3">
            <input name="cabecera" type="text" class="tbox2" id="cabecera" value="<?php echo dftipo2($_GET['tip']);?> N&deg; <?php echo fillc($_GET['num']);?>/<?php echo $row_sigla['siglas']; ?>/UNCP" /></span></td>
        </tr>
        <tr valign="baseline">
