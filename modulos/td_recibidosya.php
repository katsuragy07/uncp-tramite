...
$query_rs1 = sprintf("SELECT log_derivar.*
...
ORDER BY log_derivar.fecha DESC", GetSQLValueString($colname_rs1, "int"), GetSQLValueString($colname_rs1, "int"));
    ...
    <td valign="top"><h2>Lista de expedientes recibidos en la oficina</h2>
        <table width="90%" border="0" cellpadding="0" cellspacing="0" class="tabla2">
		  ...
		  ?>>
            ...
            <td><a href="td_verfolio.php?pk=<?php echo $row_rs1['foid'];?>"><?php echo $row_rs1['firma']."<br />
				<span class='min'>".$row_rs1['asunto']."</span>"; ?><br>
      ...
      <?php }else{ ?>No<?php } ?></td>
            <td width="160">
            <div class="spacer"><a href="td_derivar.php?fk=<?php echo $row_rs1['id']; ?>&pk=<?php echo $row_rs1['foid']; ?>">
            <div class="skin left" style="background-position:-32px -95px;margin-right:3px;"></div>
            Derivado simple</a></div>
            <div class="spacer"><a href="td_expderivar.php?fk=<?php echo $row_rs1['id']; ?>&pk=<?php echo $row_rs1['foid']; ?>">
            <div class="skin left" style="background-position:-32px -95px;margin-right:3px;"></div>
            Derivar con proveido</a></div>
            <div class="spacer"><a href="td_farchivar.php?fk=<?php echo $row_rs1['id']; ?>&pk=<?php echo $row_rs1['foid']; ?>">
            <div class="skin left" style="background-position:-48px -95px;margin-right:3px;"></div>
            Archivado simple</a></div>
            <div class="spacer"><a href="td_expfarchivar.php?fk=<?php echo $row_rs1['id']; ?>&pk=<?php echo $row_rs1['foid']; ?>">
            <div class="skin left" style="background-position:-48px -95px;margin-right:3px;"></div>
            Archivar con proveido</a></div>
            </td>
          </tr>          
