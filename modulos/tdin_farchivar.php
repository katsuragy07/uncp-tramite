...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO log_archivo_int (id, tipo, folioint_id, forma, obs, fecha, `user`, c_oficina, empid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['user'], "text"),
							  GetSQLValueString($_POST['c_oficina'], "text"),
  ...
  folio_doperado_int($_POST['deid']);  //marcar como atendido
  //folxt_aten_int($_POST['folio']); //marca folio como atendido
