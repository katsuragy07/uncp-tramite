...
$query_rs1 = "SELECT msg.*, CONCAT(empleado.apellido,', ', empleado.nombre) AS unombre FROM msg, empleado WHERE msg.empid=empleado.id ORDER BY fecha DESC";
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><h2>Mensajes enviados al sistema</h2>
      <table width="90%" border="0" cellpadding="0" cellspacing="0" class="tabla2">
          ...
          <?php if ($totalRows_rs1 > 0) { // Show if recordset not empty ?>
            <tr>
              ...
              <td width="75"><span class="min"><?php echo dptiemp($row_rs1['fecha']);?></span></td>
              <td><?php echo $row_rs1['unombre']; ?></td>
              <td><?php echo $row_rs1['obs']; ?></td>
              <td><?php echo dsis2($row_rs1['sis']); ?></td>
              </tr>
