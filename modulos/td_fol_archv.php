...
,(SELECT folioext.file FROM folioext WHERE folioext.id=log_archivo.folioext_id LIMIT 1) AS file
,(SELECT folioext.ext FROM folioext WHERE folioext.id=log_archivo.folioext_id LIMIT 1) AS ext
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><h2>Lista de expedientes archivados en la oficina</h2>
        <table width="90%" border="0" cellpadding="0" cellspacing="0" class="tabla2">
          <tr>
            ...
            <td class="btit_1">Oficina de creacion</td>
    ...
    <td width="250" valign="top"><h2>Opciones</h2>
        ...
        <div class="spacer"><a href="td_nuevo.php" >
