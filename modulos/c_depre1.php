...
mysql_select_db($database_cn1, $cn1);
$query_rs1 = "SELECT * FROM tabdepre WHERE clase=1 ORDER BY antig, mat ASC";
...
<script type="text/javascript">function dlitem(ord){if(confirm("Deseas eliminar este registro?")){document.location.href= '../opers/del_cdepre.php?fk=1&pk='+ord;}}</script>
</head>
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <h2>Casas, habitaciones, departamentos y viviendas</h2>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="tabla2">
          ...
          <tr>
            ...
            <td width="140"><div class="barlist right" style="width:140px">
                <ul>
                  <li><a href="../opers/mod_cdepre.php?fk=1&pk=<?php echo $row_rs1['id']; ?>"><span class="skin left" style="background-position:-48px -63px;margin-right:3px;"></span> Editar</a></li>
