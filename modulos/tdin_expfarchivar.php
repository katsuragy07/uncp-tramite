...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO log_archivo_int (id, tipo, folioint_id, forma, obs, fecha, `user`, c_oficina, provei, file, ext, size, empid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
