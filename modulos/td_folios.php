...
<div class="suggestionList" id="suggestionsList"> &nbsp; </div></div></div>
    ...
    <h2>Lista de expedientes registrados</h2>
      ...
      <?php }else{ ?>No<?php } ?></td>
            <td width="80">
                 ...
                 <div class="spacer"><a href="../reportes/td_cargofolio.php?pk=<?php echo $row_rs1['id']; ?>" target="_blank"><span class="skin left" style="background-position:0px -79px;margin-right:3px;"></span> Cargo</a></div>
                  </td>
          </tr>
