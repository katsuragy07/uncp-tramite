...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE lugares SET nombre=%s WHERE id=%s",
...
mysql_select_db($database_cn1, $cn1);
$query_rs1 = sprintf("SELECT * FROM lugares WHERE id = %s", GetSQLValueString($colname_rs1, "int"));
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="250" valign="top"><h2>Opciones</h2>
        ...
        <div class="spacer"><a href="../modulos/mlocal.php" >
