...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE uit SET anno=%s, valor=%s, obs=%s WHERE id=%s",
...
mysql_select_db($database_cn1, $cn1);
$query_rs1 = sprintf("SELECT * FROM uit WHERE id = %s", GetSQLValueString($colname_rs1, "int"));
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <h2>Unidad Impositiva Tributaria (UIT)</h2>
    ...
    <form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
        ...
        <tr valign="baseline">
          <td width="150" align="right" valign="middle">Valor S/.</td>
          <td><span id="sprytextfield2">
          <input name="valor" type="text" class="tbox2" id="valor" value="<?php echo $row_rs1['valor']; ?>" /></span></td>
        </tr>
        <tr valign="baseline">
    ...
    <td width="250" valign="top"><h2>Opciones</h2>
        ...
        <div class="spacer"><a href="../modulos/uit.php" >
