...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE folioint SET exp=%s, t_tipo=%s, asunto=%s, firma=%s, nfolios=%s, obs=%s, `file`=%s, ext=%s, `size`=%s, cabecera=%s WHERE id=%s",
  ...
  $updateGoTo = "../modulos/tdin_folemtd.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <h2>Modificar Expediente Interno</h2>
    <h3>Datos básicos</h3>
    <form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
        ...
        <tr valign="baseline">
          ...
          <td><?php echo dftipo($row_rs1['t_tipo']); ?> <?php echo dcoidfo($row_rs['exp'],$row_rs['fecha']);?></td>
        </tr>
        <tr valign="baseline">
    ...
    <td width="250" valign="top"><h2>Opciones</h2>
        ...
        <div class="spacer"><a href="../modulos/tdin_verfolio.php?pk=<?php echo $_GET['pk'];?>" >
