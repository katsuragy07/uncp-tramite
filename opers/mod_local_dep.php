...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE depart SET nombre=%s, corto=%s WHERE id=%s",
...
mysql_select_db($database_cn1, $cn1);
$query_rs1 = sprintf("SELECT * FROM depart WHERE id = %s", GetSQLValueString($colname_rs1, "int"));
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <h2>Localización &raquo; Departamento</h2>
    ...
    <form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
        ...
        <tr valign="baseline">
          <td width="150" align="right" valign="middle">Código ISO</td>
          <td><input name="corto" type="text" class="tbox2" id="corto" value="<?php echo $row_rs1['corto']; ?>" /></td>
        </tr>
        <tr valign="baseline">
          <td width="150">&nbsp;</td>
