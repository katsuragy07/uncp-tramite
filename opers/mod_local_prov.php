...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE provincia SET nombre=%s WHERE id=%s",
...
mysql_select_db($database_cn1, $cn1);
$query_rs1 = sprintf("SELECT * FROM provincia WHERE id = %s", GetSQLValueString($colname_rs1, "int"));
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
    <h2>Localización &raquo; Provincia</h2>
