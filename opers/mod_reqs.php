...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE reqs SET nombre=%s, descrip=%s, precio=%s, obs=%s WHERE id=%s",
...
mysql_select_db($database_cn1, $cn1);
$query_rs1 = sprintf("SELECT * FROM reqs WHERE id = %s", GetSQLValueString($colname_rs1, "int"));
...
<table <?php echo dtabla();?> border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
        ...
        <tr valign="baseline">
          ...
          <td valign="middle"><textarea name="descrip" rows="10" class="tbox2" id="descrip"><?php echo strip_tags($row_rs1['descrip']); ?></textarea></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="middle" class="btit_3">Precio</td>
          <td valign="middle"><input name="precio" type="text" class="tbox2" id="precio" value="<?php echo strip_tags($row_rs1['precio']); ?>" /></td>
        </tr>
        <tr valign="baseline">
          <td align="right" valign="middle" class="btit_3">Observaciones</td>
          <td valign="middle"><textarea name="obs" rows="3" class="tbox2" id="obs"><?php echo strip_tags($row_rs1['obs']); ?></textarea></td>
        </tr>
        <tr valign="baseline">
          <td width="150">&nbsp;</td>
    ...
    <td width="250" valign="top"><h2>Opciones</h2>
        ...
        <div class="spacer"><a href="../modulos/reqs.php" >
