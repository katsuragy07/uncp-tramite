...
if(isset($_POST['queryString'])) {
	...
	if(strlen($queryString) >0){		
		...
		FROM log_archivo INNER JOIN  folioext ON folioext.id = log_archivo.folioext_id
		WHERE log_archivo.c_oficina = $queryOfice
		...
		ORDER BY log_archivo.fecha DESC LIMIT 20;";		
