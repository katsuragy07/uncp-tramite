...
if(isset($_POST['queryString'])) {
	...
	if(strlen($queryString) >0){		
		...
		FROM log_derivar_int INNER JOIN  folioint ON folioint.id = log_derivar_int.folioint_id
		WHERE log_derivar_int.c_oficina = $queryOfice
		...
		ORDER BY log_derivar_int.fecha DESC LIMIT 20;";		
