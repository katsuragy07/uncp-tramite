<?php
include_once("../Connections/cn1.php");

define( DBHOST, $hostname_cn1, true ); // The true makes it so you have to type in DBHOST
define( DBUSER, $database_cn1, true ); // in caps to retreive the string.
define( DBPASS, $username_cn1, true );
define( DBNAME, $password_cn1, true );
...
// Allows you to utilize the resourses of the returned mysql_query().
